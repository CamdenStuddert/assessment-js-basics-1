...
const analysisOfRequirements = `This is a communication stage for creating the expectations of the project`

const design = `this stage takes the requirements in a structured design`

const implementation = `implementing the design`

const testingAndIntegration = `the testing of the code`

const maintain = `Maintain/update your code so it works`